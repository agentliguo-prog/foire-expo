...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-[9999] flex items-center group pointer-events-auto">
      ...
      <a
        ...
        className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_10px_25px_rgba(37,211,102,0.5)] hover:scale-110 active:scale-95 transition-all duration-200 pulse-whatsapp focus:outline-none focus:ring-4 focus:ring-[#25D366]/50 shrink-0"
      >
        <MessageCircle className="w-7 h-7 sm:w-8 sm:h-8 fill-white stroke-none" />
      </a>
    </div>
  );
};
